...
*/
    ...
    modal.caculate = function() {
        ...
        core.json('order/create/caculate', {
            ...
            if (getjson.status == 1) {
                ...
                if (getjson.result.yddeductcredit) {
                    $('#yddeductcredit_money').html(core.number_format(getjson.result.yddeductmoney, 2));
                    //$('#yddeductcredit_info').html(getjson.result.yddeductcredit);
                    $("#yddeductcredit").data('credit', getjson.result.yddeductcredit);
                    $("#yddeductcredit").data('money', core.number_format(getjson.result.yddeductmoney, 2))
                }
    ...
    modal.totalPrice = function(couponprice) {
        ...
        if ($("#deductcredit").length > 0) {
            if ($("#deductcredit").prop('checked')) {
                ...
                if ($("#yddeductcredit").length > 0) {
                    var td1 = core.getNumber($("#yddeductcredit").data('money'));
                    if (totalprice - deductprice >= 0) {
                        td = totalprice - deductprice;
                    }
                    var td = totalprice - deductprice;
                    if (td > td1) {
                        td = td1
                    }
                    $("#yddeductcredit_money").html(core.number_format(td, 2));
                    }
            } else {
                if ($("#deductcredit2").length > 0) {
                ...
                if ($("#yddeductcredit").length > 0) {
                    var td = core.getNumber($("#yddeductcredit").data('money'));
                    $("#yddeductcredit_money").html(core.number_format(td, 2))
                }
            }
        }
        ...
        var yddeductprice = 0;
        if ($("#yddeductcredit").length > 0) {
            if ($("#yddeductcredit").prop('checked')) {
                yddeductprice = core.getNumber($("#yddeductcredit_money").html())
            }
        }
        totalprice = totalprice - deductprice - deductprice2-yddeductprice;
        if (totalprice <= 0) {
            totalprice = 0
        }
    ...
    modal.submit = function(obj, token) {
        ...
        var data = {
            ...
            'deduct3': ($("#yddeductcredit").length > 0 && $("#yddeductcredit").prop('checked')) ? 1 : 0,
            'contype': modal.params.contype,
            'couponid': modal.params.couponid,
            'wxid': modal.params.wxid,
            'wxcardid': modal.params.wxcardid,
