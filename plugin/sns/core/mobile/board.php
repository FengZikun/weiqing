...
class Board_EweiShopV2Page extends SnsMobilePage 
{
	...
	public function getlist() 
	{
		...
		$sql = 'select id,title,createtime,content,images , nickname,avatar,isbest,isboardbest,checked,unit,price,phone,bs from ' . tablename('ewei_shop_sns_post') . '  where 1 ' . $condition . ' ORDER BY createtime desc,id DESC LIMIT ' . (($pindex - 1) * $psize) . ',' . $psize;
