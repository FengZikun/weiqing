...
class Index_EweiShopV2Page extends WebPage 
{
	...
	protected function ajaxgetcredit(){

		global $_GPC;
		global $_W;
		$param = array(':uniacid' => $_W['uniacid']);

		$member_count = pdo_fetch('select sum(credit10) credit10,sum(credit11) credit11 from ' . tablename('mc_members') . ' where uniacid=:uniacid', $param);

		return array('credit11'=>$member_count['credit11'],'credit10'=>$member_count['credit10']);
	}
	...
	{
		echo json_encode(array('ajaxmembergender' => $this->ajaxmembergender(), 'ajaxmemberlevel' => $this->ajaxmemberlevel(), 'ajaxprovince' => $this->ajaxprovince(), 'ajaxnewmember0' => $this->ajaxnewmember(0), 'ajaxnewmember1' => $this->ajaxnewmember(1), 'ajaxnewmember7' => $this->ajaxnewmember(7), 'ajaxydcredit' => $this->ajaxgetcredit()));
	}
}
?>